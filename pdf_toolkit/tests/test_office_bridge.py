...
from core.office_bridge import get_soffice_path, run_soffice_conversion
from core.utils import LibreOfficeNotFoundError, ConversionError
...
@patch("core.office_bridge.Path.exists")
...
@patch("core.office_bridge.get_soffice_path")
@patch("core.office_bridge.subprocess.run")
